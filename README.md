# inventory-web-app
This Inventory Web App allow users to add new book to the inventory and delete existing book.
...
Clicking "In Stock" or "Out of Stock" will toggle the value for that book. The label is visually distinctive depending on the status of the book.

Heres' the Link for thid project: https://jordandorcelus.github.io/inventory-web-app/ 
